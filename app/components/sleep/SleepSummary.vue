...
import { msToHHMM } from '@/utils'

const { summary } = defineProps<{ summary: SleepSummary }>()
</script>
...
<template>
  <UPageGrid class="lg:grid-cols-2">
    <UPageCard>
      ...
      <div class="mt-2">
        <UProgress :model-value="summary.awakeTimePercentage" color="neutral" />
      </div>
    </UPageCard>
    ...
    <UPageCard>
      ...
      <div class="mt-2">
        <UProgress
          :model-value="summary.lightSleepPercentage"
          :ui="{
    ...
    <UPageCard>
      ...
      <div class="mt-2">
        <UProgress
          :model-value="summary.SWSPercentage"
          :ui="{
    ...
    <UPageCard>
      ...
      <div class="mt-2">
        <UProgress
          :model-value="summary.REMSleepPercentage"
          :ui="{
